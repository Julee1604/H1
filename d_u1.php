...
<html lang="en">
    ...
    <body>
        ...
        <section id="1.Vorlagen">
            ...
            <h3 id="überschriften" data-aos="fade-left">Schutzschilder zu Corona-Zeiten</h3>
            <br>
 ...
 <div class="container1">
        <div class="row">
          <div class="col-lg-3">
            <img src="img/frau.jpeg" class="img"  class="img" style="margin-bottom: 2rem;" width="80%">
          </div>
          <div class="col-lg-9">
            Lorem hallo ipsum dolor sit amet, consetetur sadipscing elitr, sed diam

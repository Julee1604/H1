...
<section id="inner-page" class="dienstleistungen">
        ...
        <!-- Überschrift -->
            <div class="container" style="margin-top: 4rem;">
              <h2>Besuch der neuen Präsidentin der DHBW</h2>
    ...
    <div class="container">
          ...
          <div class="col order-first">
            <img src="img/Besuch1.jpeg" class="img-fluid" alt="">
          </div>
          
          <div class="col order-last">
          <img src="img/Besuch3.jpeg" class="img-fluid" alt="">
          </div>
             </div>
             <p>Ende März 2022 war die neue Präsidentin der DHBW, Frau Prof. Martina Klärle, am Standort Heidenheim zu Besuch und hat unter anderem die Labore besichtigt.</p>            
    </div>
